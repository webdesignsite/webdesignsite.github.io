...
$(function(){$(".toggle_mnu").click(function(){$(this).toggleClass("on"),$(".main-mnu").slideToggle()}),$(".works-foto").magnificPopup({delegate:"a",type:"image",closeOnContentClick:!1,closeBtnInside:!1,mainClass:"mfp-with-zoom mfp-img-mobile",image:{verticalFit:!0,titleSrc:function(e){return e.el.attr("title")+' &middot; <a class="image-source-link" href="'+e.el.attr("data-source")+'" target="_blank">image source</a>'}},gallery:{enabled:!0},zoom:{enabled:!0,duration:300,opener:function(e){return e.find("img")}}}),$(".peoples").owlCarousel({items:1,loop:!0,center:!0,nav:!1}),$(".partners").owlCarousel({loop:!0,nav:!0,dots:!1,smartSpeed:700,navText:['<i class="fa fa-angle-double-left" aria-hidden="true"></i>','<i class="fa fa-angle-double-right" aria-hidden="true"></i>'],responsiveClass:!0,responsive:{0:{items:1},800:{items:2},1100:{items:3}}}),$(".workers").owlCarousel({loop:!0,nav:!1,dots:!0,smartSpeed:700,navText:['<i class="fa fa-angle-double-left" aria-hidden="true"></i>','<i class="fa fa-angle-double-right" aria-hidden="true"></i>'],responsiveClass:!0,items:1}),$(".buttons").click(function(){}).magnificPopup({type:"inline",mainClass:"mfp-forms"}),$(".alo").click(function(){}).magnificPopup({type:"inline",mainClass:"mfp-forms"}),$(".forms").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"/mail.php",data:e.serialize()}).done(function(){alert("Thank you!"),setTimeout(function(){$(".forms").trigger("reset")},1e3)}),!1}),$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(".top").addClass("active"):$(".top").removeClass("active")}),$(".top").click(function(){$("html, body").stop().animate({scrollTop:0},"slow","swing")}),$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(".alo").addClass("active"):$(".alo").removeClass("active")}),$(".menu a").mPageScroll2id({})});